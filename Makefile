...
EXPANDER_FILES		=	ambiguous_redirect_utils.c create_final_cmd_table_utils.c create_final_cmd_table.c expander_memory_handle.c expander.c here_doc_expansions_utils.c here_doc_expansions.c parameter_expansion_utils.c parameter_expansion.c quote_removal_expansion_utils.c quote_removal_expansion.c wildcard_expansion_utils.c wildcard_expansion.c
