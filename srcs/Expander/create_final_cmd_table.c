...
t_final_cmd_table	*new_f_cmd_table_node(t_minishell *msh,
	t_command_table *command_table, t_symbol previous_symbol)
{
	...
	t_command_table *command_table)
{
	...
	while (command_table)
	{
		new_table_node = new_f_cmd_table_node(msh, command_table,
				previous_symbol);
		if (!new_table_node)
		{
