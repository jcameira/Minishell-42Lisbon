...
/*   Updated: 2024/04/24 19:17:17 by jcameira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

//Builtin functions to be made
//->echo (need to be able to handle -n option)
//->cd (only with relative or absolute path, should be easy enough to add only cd,
//cd .. and cd - but totally not mandatory, just easy enough)
//->pwd
//->export
//->unset
//->env
